import{_ as a,c as n,aU as l,a as e}from"./chunks/framework.DIXiA2XH.js";const m=JSON.parse('{"title":"Skill","description":"","frontmatter":{},"headers":[],"relativePath":"note/ai/ai/Skill.md","filePath":"note/ai/ai/Skill.md","lastUpdated":1779983244000}'),p={name:"note/ai/ai/Skill.md"};function i(r,s,t,c,b,o){return e(),n("div",null,[...s[0]||(s[0]=[l(`<h1 id="skill" tabindex="-1">Skill <a class="header-anchor" href="#skill" aria-label="Permalink to &quot;Skill&quot;">​</a></h1><h2 id="skill打包提示词" tabindex="-1">Skill打包提示词 <a class="header-anchor" href="#skill打包提示词" aria-label="Permalink to &quot;Skill打包提示词&quot;">​</a></h2><div class="language-text vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>我们刚才的对话已经磨合出了完整的工作流程和输出标准。</span></span>
