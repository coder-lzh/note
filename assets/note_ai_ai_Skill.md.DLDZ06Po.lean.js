import{_ as n,c as a,aU as i,a as p}from"./chunks/framework.DIXiA2XH.js";const d=JSON.parse('{"title":"Skill","description":"","frontmatter":{},"headers":[],"relativePath":"note/ai/ai/Skill.md","filePath":"note/ai/ai/Skill.md","lastUpdated":1786275371000}'),l={name:"note/ai/ai/Skill.md"};function e(r,s,t,h,k,c){return p(),a("div",null,[...s[0]||(s[0]=[i(`<h1 id="skill" tabindex="-1">Skill <a class="header-anchor" href="#skill" aria-label="Permalink to &quot;Skill&quot;">​</a></h1><h2 id="skill的目录" tabindex="-1">Skill的目录 <a class="header-anchor" href="#skill的目录" aria-label="Permalink to &quot;Skill的目录&quot;">​</a></h2><div class="language-text vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>my-skill/</span></span>
